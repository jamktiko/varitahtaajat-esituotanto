...
Tiimilemme tämä on tärkeä, koska haluamme suojella luontoa ja edistää yhdenvertaisuutta.
...
Tietoisuuden lisääminen väreistä (SDG4: Hyvä koulutus)
...
Minimoidaan energiakulutusta optimoimalla koodin. Käytetään tekoälyä tarpeen mukaan. Ei kulutetaan energia turhaan.
...
Sovelluksemme ei vaikuta luonnonvarojen kulutukseen mitenkään.
...
Sovelluksen lähdekoodi ja kehitysprosessi dokumentoidaan. Meidän sovellus on riippuvainen ulkoisista lähdekoodista.
...
Sovelluksemme ei ole riippuvainen käyttäjän ominaisuuksista. Se on saatavilla kaikille, koska se on yksinkertainen väripeli. Sovellus kehitetään suomen kielellä ja on mahdollista englannin kielellä kehittää tulevaisuudessa.
...
Meidän sovelluksemme ei vaikuta suoraan sosiaalisiin suhteisiin, terveyteen tai mielialaan. Kuitenkin sovelluksen liikaa käyttö voi aiheuttaa silmien kipua.
...
Sovelluksemme ei ollenkaan vaikuta laajasti yhteiskuntaan. Ja se ei vaati käyttäjän henkilökohtaisen tiedon.
...
Me noudetaan ketterää kehitystä. Tavoitteet ovat selkeitä ja myös realistisia. Tiimijäsenten hyvinvointi otettu huomioon.
